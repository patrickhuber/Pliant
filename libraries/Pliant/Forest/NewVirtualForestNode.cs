...
{
    public class NewVirtualForestNode : ForestNodeBase, ISymbolForestNode
    {
        ...
        protected NewVirtualForestNode(
            int location,
            ITransitionState transitionState,
            IForestNode completedParseNode,
            IState targetState)
        ...
        private void LazyLoadPath(VirtualForestNodePath path)
        {
            ...
            {
                var virtualNode = new NewVirtualForestNode(Location, transitionState.NextTransition, completedParseNode);
